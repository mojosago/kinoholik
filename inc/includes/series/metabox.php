<?php function series_add_meta_box() { 
	add_meta_box('mt_metabox', __( 'TVShows Info', 'mtms' ),'series_html','tvshows','normal','high'); 
}
	...
	<tbody>
		...
		<tr id="ids_box">
			...
			<td class="field">
				...
				<input type="button" class="button button-primary" name="generartv" value="<?php if(dt_get_meta( 'ids' )){ _e('Update data','mtms'); } else { _e('Generate','mtms'); } ?>">
				<p class="description"><?php _e('E.g. https://www.themoviedb.org/tv/<strong>1402</strong>-the-walking-dead','mtms'); ?></p>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2"><h3><?php _e( 'More data', 'mtms' ); ?></h3></td>
		</tr>
		<tr id="original_name_box">
			<td class="label">
				<label for="original_name"><?php _e( 'Original Name', 'mtms' ); ?></label>
			</td>
			<td class="field">
		...
		<tr id="first_air_date_box">
			<td class="label">
				<label for="first_air_date"><?php _e( 'Firt air date', 'mtms' ); ?></label>
			</td>
			<td class="field">
		...
		<tr id="last_air_date_box">
			<td class="label">
				<label for="last_air_date"><?php _e( 'Last air date', 'mtms' ); ?></label>
			</td>
			<td class="field">
		...
		<tr id="elements_box">
			<td class="label">
				<label for="number_of_seasons"><?php _e( 'Content total posted', 'mtms' ); ?></label>
				<p class="description"><?php _e( 'Seasons / Episodes', 'mtms' ); ?></p>
			</td>
			<td class="field">
		...
		<tr id="rating_box">
			<td class="label">
				<label for="imdbRating"><?php _e( 'Rating TMDb', 'mtms' ); ?></label>
		...
		<tr id="status_box">
			<td class="label">
				<label for="status"><?php _e( 'Status', 'mtms' ); ?></label>
			</td>
			<td class="field">
		...
		<tr id="runtime_box">
			<td class="label">
				<label for="episode_run_time"><?php _e( 'Episode runtime', 'mtms' ); ?></label>
			</td>
			<td class="field">
		...
		<tr id="dt_creator_box">
			<td class="label">
				<label for="dt_creator"><?php _e( 'Creator', 'mtms' ); ?></label>
			</td>
			<td class="field">
            ...
            jQuery.getJSON(url + input + "/credits?" + apikey, function(tmdbdata) {
                ...
                jQuery.getJSON(url + input + "/videos?" + apikey, function(tmdbdata) {
                    jQuery.each(tmdbdata, function(key, val) {
                        ...
                        jQuery('input[name="youtube_id"]').val(videomt);
                    });
                });
            });
        });
...
<div class="dtloadpage">
	<div class="dtloadbox">
		...
		<span><?php _e('Generating seasons','mtms'); ?></span>

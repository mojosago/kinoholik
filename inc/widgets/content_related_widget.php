<?php
/**
 * Plugin Name: Sidebar related content
 * Description: Sidebar related content
 * Version: 1.0
 * Author: Erick Meza
...
class DT_Widget_related extends WP_Widget {
	function DT_Widget_related() {
		$widget_ops = array( 'classname' => 'doothemes_widget', 'description' => __('A widget to show related content in the sidebar', 'mtms') );
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'dtw_content_related' );
		$this->WP_Widget( 'dtw_content_related', __('DooPlay - Sidebar related content', 'mtms'), $widget_ops, $control_ops );
	}

<?php if( get_option('dt_commets') == 'comtwp') { comments_template('', true); } ?>
...
<?php } else { ?>
<?php _e("<strong>Disqus:</strong> add shortname your comunity, <a href=\"https://help.disqus.com/customer/portal/articles/466208-what-s-a-shortname-\" target=\"_blank\">more info</a>","mtms"); ?>
<?php } ?>
</div>
<?php } ?>

...
<li>
	...
	<div class="numerando"><?php echo $value_t['season']; ?>x<?php echo data_of('episodio',$value_c['id']); ?></div>
	<div class="episodiotitle">
	<a href="<?php echo get_permalink( $value_c['id'] ); if(data_of('repeatable_fields', $value_c['id'])) { echo '?player=option-1'; } ?>"><?php if(data_of('episode_name', $value_c['id']) != "N/A") { echo data_of('episode_name', $value_c['id']); } ?></a>
	<span class="date"><?php $date = new DateTime(data_of('air_date', $value_c['id'])); echo $date->format('M d, Y'); ?></span>
	</div>
</li>
<?php	
} 

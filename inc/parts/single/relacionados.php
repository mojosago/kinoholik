...
$args = array('post_type' => get_post_type($post->ID),'posts_per_page' => 12,'orderby' => 'rand','order' => 'asc','tax_query' => array('relation' => 'OR',
...
<article>
<a href="<?php the_permalink() ?>"><img src="<?php if($thumb_id = get_post_thumbnail_id()) { $thumb_url = wp_get_attachment_image_src($thumb_id,'dt_poster_a', true); echo $thumb_url[0]; } else { dt_image('dt_poster', $post->ID, 'w185'); } ?>" alt="<?php the_title(); ?>" /></a>
</article>

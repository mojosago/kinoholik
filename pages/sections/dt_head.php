...
<?php if (wp_is_mobile()) : /* none */ else: ?> 
<?php if(get_option('dt_color_scheme')=='bluestorm') { ?><style>body {background:#3f474e}.text_ft{color:rgba(255, 255, 255, 0.6)}</style><?php } ?>
<?php if(get_option('dt_color_scheme')=='bluestorm-dark') { ?><style>body {background:#3f474e}.text_ft{color:rgba(255, 255, 255, 0.6)}</style><?php } ?>
<?php if(get_option('dt_color_scheme')=='fusion') { ?><style>body {background:#353d50}.text_ft{color:rgba(255, 255, 255, 0.6)}</style><?php } ?>
<?php if(get_option('dt_color_scheme')=='white') { ?><style>body {background:#F5F7FA;}.text_ft{color:#222D34}</style><?php } ?>
<?php endif; ?>
